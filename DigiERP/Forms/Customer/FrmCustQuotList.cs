...
{
    public partial class FrmCustQuotList : Form
    {
        ...
        private void initGrid()
        {
            ...
            CommonRep<C報價明細> commonRep = customerController.GetQuotationListByCustid(_custName);
            foreach(var item in commonRep.resultList)
            {
                ...
                row.Cells[index++].Value = item.CONDATE;
