...
namespace MES.Core.Model
{
    public class A材料
    {
        ...
        public string? 外尺寸長 { get; set; }
        public string? 外尺寸寬 { get; set; }
        public string? 厚度 { get; set; }
        public string? 內徑 { get; set; }
        public string? 外徑 { get; set; }
        public string? 庫存單位 { get; set; }
        public string? 採購單位 { get; set; }
        public string? 採購換算倍數 { get; set; }
        public string? 銷售單位 { get; set; }
        public string? 銷售換算倍數 { get; set; }
